...
objects = []
# Eugen add these global variable used in update function in Mussroom class
game_speed = 17
...
def menu(death_count,objects,player,objectt):
    ...
    while run:
            ...
            if death_count == 0:
                ...
                text2= font.render("The player has stopped by stone!!!!!.", True, FONT_COLOR)

            score = font.render("Your Score: " + str(points), True, RED)
